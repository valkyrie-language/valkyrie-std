...
[c("libSystem", "write")]
micro darwin_write(fd: i32, buf: c_str, length: i32): i32

[c("libSystem", "read")]
micro darwin_read(fd: i32, buf: i32, length: i32): i32
...
[c("libSystem", "mmap")]
micro darwin_mmap(addr: i32, length: i32, prot: i32, flags: i32, fd: i32, offset: i64): i32

[c("libSystem", "munmap")]
micro darwin_munmap(addr: i32, length: i32): i32
