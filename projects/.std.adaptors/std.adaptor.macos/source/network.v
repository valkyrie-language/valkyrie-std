# macOS BSD socket network host_provider for std.network

[c("libSystem", "socket")]
micro darwin_socket(domain: i32, type_: i32, protocol: i32): i32

[c("libSystem", "bind")]
micro darwin_bind(fd: i32, addr: i32, length: i32): i32

[c("libSystem", "listen")]
micro darwin_listen(fd: i32, backlog: i32): i32

[c("libSystem", "accept")]
micro darwin_accept(fd: i32, addr: i32, length: i32): i32

[c("libSystem", "connect")]
micro darwin_connect(fd: i32, addr: i32, length: i32): i32

[c("libSystem", "close")]
micro darwin_net_close(fd: i32): i32

[host_provider(std::network::net_socket_create)]
micro net_socket_create(domain: i32, type_: i32, protocol: i32): i32 {
    return darwin_socket(domain, type_, protocol)
}
