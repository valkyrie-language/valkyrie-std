...
[wasi("wasi:clocks/monotonic-clock", "resolution")]
private micro wasi_clock_monotonic_resolution(): i64

[wasi("wasi:clocks/wall-clock", "now")]
private micro wasi_clock_wall_now(): (i64, i32)
