...
micro win_write_console(handle: i32, buf: utf16, length: i32): i32

[c("kernel32", "ReadConsoleW")]
micro win_read_console(handle: i32, buf: i32, length: i32): i32
...
micro nt_create_file(handle: i32, access: i32, obj_attr: i32, io_status: i32, alloc_size: i32, file_attr: i32, share_access: i32, disposition: i32, options: i32, ea: i32, ea_length: i32): i32

[syscall("NtClose")]
micro nt_close(handle: i32): i32

[syscall("NtReadFile")]
micro nt_read_file(handle: i32, event: i32, apc: i32, apc_ctx: i32, io_status: i32, buf: i32, length: i32, offset: i32, key: i32): i32

[syscall("NtWriteFile")]
micro nt_write_file(handle: i32, event: i32, apc: i32, apc_ctx: i32, io_status: i32, buf: i32, length: i32, offset: i32, key: i32): i32
