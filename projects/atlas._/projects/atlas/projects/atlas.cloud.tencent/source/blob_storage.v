# 腾讯云 COS 实现（对标 C# TencentBlobStorage）
...
class TencentBlobStorage {
    secret_id: utf8
    secret_key: utf8
    region: utf8
}

imply TencentBlobStorage {
    micro new(secret_id: utf8, secret_key: utf8, region: utf8): Self {
        return Self {
            secret_id: secret_id,
    ...
    micro build_object_url(self, bucket: utf8, key: utf8): utf8 {
        ...
        url = url.concat(".cos.")
        url = url.concat(self.region)
        url = url.concat(".myqcloud.com/")
        url = url.concat(key)
        return url
    }
