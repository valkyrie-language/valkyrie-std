...
micro write_package_meta(path: utf8, package: Package) -> bool {
    let q: utf8 = "\u{22}"
    # One assignment per statement — CLR body splitter cannot take multi-line `+` continuations.
    let mut content: utf8 = "{\n"
    content = content + "    name: " + q + package.name + q + ",\n"
    content = content + "    version: " + q + package.version + q + ",\n"
    content = content + "    description: " + q + package.description + q + ",\n"
    content = content + "    homepage: " + q + package.homepage + q + ",\n"
    content = content + "    author: " + q + package.author + q + ",\n"
    content = content + "    license: " + q + package.license + q + ",\n"
    content = content + "    dist_path: " + q + package.dist_path + q + ",\n"
    content = content + "    integrity: " + q + package.integrity + q + ",\n"
    content = content + "}\n"
