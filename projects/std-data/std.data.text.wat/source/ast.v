...
unite WatImportDescriptor {
    Func(WatFuncImportDescriptor)
    Memory(WatMemoryImportDescriptor)
    Table(WatTableImportDescriptor)
    Global(WatGlobalImportDescriptor)
}
...
unite WatInstruction {
    Const(WatConstInstruction)
    Variable(WatVariableInstruction)
    Call(WatCallInstruction)
    Control(WatControlInstruction)
    Memory(WatMemoryInstruction)
    Simple(WatSimpleInstruction)
    Binary(WatBinaryInstruction)
    Unary(WatUnaryInstruction)
    Compare(WatCompareInstruction)
    Generic(WatGenericInstruction)
}
