...
micro dom_set_attr(handle: i32, name: utf16, value: utf16): unit

[js_builtin("Element.getAttribute")]
micro dom_get_attr(handle: i32, name: utf16): utf16

[js_builtin("Element.removeAttribute")]
micro dom_remove_attr(handle: i32, name: utf16): unit

[js_builtin("Element.textContent")]
micro dom_set_text(handle: i32, text: utf16): unit

[js_builtin("Element.innerHTML")]
micro dom_set_inner_html(handle: i32, html: utf16): unit
...
micro dom_set_style(handle: i32, prop: utf16, value: utf16): unit

[js_builtin("Element.classList.add")]
micro dom_class_add(handle: i32, token: utf16): unit

[js_builtin("Element.classList.remove")]
micro dom_class_remove(handle: i32, token: utf16): unit

[js_builtin("Element.classList.toggle")]
micro dom_class_toggle(handle: i32, token: utf16): unit
...
micro dom_append(parent: i32, child: i32): unit

[js_builtin("Element.removeChild")]
micro dom_remove_child(parent: i32, child: i32): unit

[js_builtin("Element.insertBefore")]
micro dom_insert_before(parent: i32, child: i32, ref: i32): unit

[js_builtin("Element.replaceChild")]
micro dom_replace_child(parent: i32, child: i32, old: i32): unit
...
micro dom_add_event(handle: i32, event: utf16, callback: i32): unit

[js_builtin("Element.removeEventListener")]
micro dom_remove_event(handle: i32, event: utf16, callback: i32): unit
