...
micro get_current_directory() -> utf8 {
    return __get_current_directory()
}
...
micro get_files(path: utf8, pattern: utf8, recursive: bool) -> [utf8] {
    ...
    return __get_files(path, pattern, search_option)
}

[clr("System.IO.FileSystem", "System.IO.File", "ReadAllText")]
private micro __read_file_text(path: utf8): utf8

[clr("System.IO.FileSystem", "System.IO.File", "WriteAllText")]
private micro __write_file_text(path: utf8, content: utf8): unit
...
private micro __create_directory(path: utf8): unit

[clr("System.IO.FileSystem", "System.IO.Directory", "GetCurrentDirectory")]
private micro __get_current_directory(): utf8

[clr("System.IO.FileSystem", "System.IO.Directory", "GetFiles")]
private micro __get_files(path: utf8, pattern: utf8, search_option: i32): [utf8]
