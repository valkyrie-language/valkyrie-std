# Windows Winsock network host_provider for std.network

namespace std.adaptor.windows.network;

[c("ws2_32", "WSAStartup")]
micro win_wsa_startup(version: i32, data: i32): i32

[c("ws2_32", "socket")]
micro win_socket(domain: i32, type_: i32, protocol: i32): i32

[c("ws2_32", "bind")]
micro win_bind(fd: i32, addr: i32, length: i32): i32

[c("ws2_32", "listen")]
micro win_listen(fd: i32, backlog: i32): i32

[c("ws2_32", "accept")]
micro win_accept(fd: i32, addr: i32, length: i32): i32

[c("ws2_32", "connect")]
micro win_connect(fd: i32, addr: i32, length: i32): i32

[c("ws2_32", "closesocket")]
micro win_closesocket(fd: i32): i32

[host_provider(std::network::net_socket_create)]
micro net_socket_create(domain: i32, type_: i32, protocol: i32): i32 {
    return win_socket(domain, type_, protocol)
}
